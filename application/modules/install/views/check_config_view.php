<?php
...

	{
...

		{
			...
			$error .= '<div class="alert alert-error">SITE_ROOT/'.$file.' is not writable. Please change it\'s permission before installing [ERROR].</div>';
...

	{
		...
		<p class="lead">Everything seems to be ok. Let's install BizDirectory with in 2 easy step :-)</p>
