...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>BizDirectory Installation</title>
  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          <a class="brand" href="<?php echo site_url('install');?>">BizDirectory Installation</a>
	...
	<div id="footer">
      <div class="container">
        <p class="muted credit">Developed By <a href="#">KITBizDirectory</a></p>
      </div>
    </div>
