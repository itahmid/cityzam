    ...
    <ul class="nav nav-list">
        ...
        <?php if (is_admin()) { ?>
            ...
            <li class="<?php echo is_active_menu('admin/system'); ?>">
                ...
                <!-- ZamCode Module-->
                <li class="<?php echo is_active_menu('admin/zamcode'); ?>">

                    <a href="#" class="dropdown-toggle">

                        <i class="fa fa-cog"></i>

                        <span><?php echo lang_key('zamcode'); ?></span>
                    ...
                    <li class="<?php echo is_active_menu('admin/zamcode/addnew'); ?>"><a
                            href="<?php echo site_url('admin/zamcode/addnew'); ?>"><?php echo lang_key('manage_zamcodes'); ?></a></li>

                    <li class="<?php echo is_active_menu('admin/zamcode/find'); ?>"><a
                            href="<?php echo site_url('admin/zamcode/find'); ?>"><?php echo lang_key('find_zamcode'); ?></a>
                    </li>
