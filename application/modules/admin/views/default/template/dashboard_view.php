   ...
   google.maps.event.addDomListener(window, 'load', initialize);
      ...
      <div class="page-title">
        ...
        <div>
          ...
          <h1><i class="fa fa-file-o"></i> <?php echo lang_key('dashboard');?> <div class="version">BizDirectory BizDirectory - version : <?php echo $config[0]->version;?></div></h1>
...
<div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="tile">
                  ...
                  <p class="title">
                    ...
                    BizDirectory BizDirectory - Listing your local businesses
              ...
              <div class="col-md-12 tile-active">
                ...
                <div class="tile tile-blue">
                  ...
                  <p>
                      ...
                      BizDirectory is the most complete and easy to manageable WebApp
    ...
    <div class="row">
      <div class="col-md-12">
      <!-- Docs and Support Links to be fixed... -->
      </div>
    </div> 
<style type="text/css">
  .version{
