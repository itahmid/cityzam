...
<head>
    ...
    <title>KITBizDirectory | Admin Panel</title>
...
<body>
  <?php //include 'template/theme_settings.php';?>
    <div class="container" id="main-container">
        <div class="domreg">
          <h4>Please register your BizDirectory with KITAppServer</h4>
          <p>You need to register you copy of BizDirectory first with KITAppServer.</p>
          <div class="row" style="text-align:center">
              ...
              <form action="<?php echo site_url('admin/purchase/addkey');?>" method="POST" class="form-horaizontal">
                <label>BizDirectory setup url : </label>
